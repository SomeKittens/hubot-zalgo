...
//
// Configuration:
//   NO_HOPE_THROUGH_CONFIGURATION
//
// Commands:
//   hubot zalgo (me) <text> - ̧͖̠̙I҉͕̗̝̝n̘̹v̞̣̝͔͍ọ̦̳̯͞k͖̫i͔n͇̟g̡͓ ̹̩the ͚̺͚̫̦f͕͕͔̜̼̞̀e̠͔̖̜͓̭̥e͏͙͈̦lin͎͉̭̮̫̹̝g͍̹͖ ̦͈̬̼̠͖óf̳̣̼͜ͅ ̨͎̼͇ͅc̦͞h̞̘̠̹̹̤ͅa̢̯o̫̱̼͉s̩͙͔͇̳̬̦.͏̞̫͇
//
// Author:
//   Randall 'SomeKittens' Koutnik
var bod=bot={};bot.addCommand=function(){};;;;
;(function(/* <[^>]> the b̗o̴̻̰̼͙̭̹̩i̛̫͍̻̗̻͈͉d̗̺̮̺͇̜ who s̯̯̜͙̪e̦͖̮͇͕͓e͙̱͚̯̫s̠̮̬͈͔̠̀ ̬̰̼͞a̶̼̩̻̘̦̟͈l̷͉̙͚̰̬̥l͞....*/) {// zIRAK IS gOING TOkILL ME KEHEHEHEHEH
  var zalgo = function ( args, MASTER ) {var ZALGO=function(ZA_LGO) {       return Math.floor(Math.random() * ZA_LGO);
}/*<([a-z]+) *[^/]*?>*/
    ...
    var ZALGO_LEVEL = MASTER.random([0,1,2]);
  var zalgo_up = [
    '\u030d','\u030e','\u0304','\u0305',
    '\u033f','\u0311','\u0306','\u0310',
    '\u0352','\u0357','\u0351','\u0307',
...
//ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO ZALGO
            for(var j=0; j<ZALGO_UP; j++)
              ZALGO_RESPONSE /*<([a-z]+) *[^/]*?>*/+= MASTER.random(zalgo_up);
                ...
                ZALGO_RESPONSE += MASTER.random(zalgo_mid);
              for(var j=0; j<ZALGO_DOWN; j++)
            ZALGO_RESPONSE += MASTER.random(zalgo_down);
          /*
...
module.exports = COMPLETEZALGOIFICATION;